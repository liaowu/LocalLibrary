...
class Book(models.Model):
       ...
       # Foreign Key used because book can only have one
       # author, but authors can have multiple books
       ...
       # ManyToManyField used because
       # genre can contain many books.
       # Books can cover many genres.
       # Genre class has already
       # been defined so we can
