...
#    num_word_types=Book.objects.all().filter(title__contains='book').genre.count()
    ...
    return render(
        request,
        'index.html',
        context={'num_books':num_books,'num_instances':num_instances,'num_instances_available':num_instances_available,'num_authors':num_authors,'num_word_book':num_word_book,'num_visits':num_visits},
    )
